...
+ Erste Schritte {#get-started}
   + [Einführung in Flags](getting-started/introduction.md)
   + [Warum Flags verwenden?](getting-started/why-use-flags.md)
   + [Flags-Modi](getting-started/flags-modes.md)
+ Konzepte {#concepts}
